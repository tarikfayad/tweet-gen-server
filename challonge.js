...
module.exports = function(){
    ...
    this.getTwitterHandles = async function(organization, tournament, matches) {
        var handles = [];
        var playerIDs = [];
    ...
    this.getUsernamesAndScores = async function(organization, tournament, matches) {
        var handles = [];
        var playerIDs = [];
    ...
    this.getFinalResults = async function(organization, tournament, matches) {
